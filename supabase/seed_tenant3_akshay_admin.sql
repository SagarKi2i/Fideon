...
--
-- Tenant seed: Tenant_3 — professional plan, global_admin role.
-- User: Akshay Pimpale <akshay.pimpale@ideastoimpacts.com>
-- ============================================================================
--
-- HOW TO USE THIS SEED (self-hosted / staging)
-- ----------------------------------------------------------------------------
-- 1) Go to Dashboard → Authentication → Users → Add user
--    Email    : akshay.pimpale@ideastoimpacts.com
--    Password : Test@123
...
DECLARE
  -- ==================== CONFIG ====================
  c_seed_email              TEXT    := 'akshay.pimpale@ideastoimpacts.com';
  c_tenant_display_name     TEXT    := 'Tenant_3';
  c_full_name               TEXT    := 'Akshay Pimpale';
  c_plan                    TEXT    := 'professional';           -- starter | professional | enterprise
  c_workflow_addon_slots    INTEGER := 0;                        -- 0–5
  c_agent_packs             TEXT[]  := ARRAY['claims'];          -- Claims Pack
  c_device_name             TEXT    := 'Akshay primary device';
  c_signup_wizard_version   TEXT    := 'v1';
  c_device_profile          JSONB   := jsonb_build_object(
    'device_name',                'Akshay primary device',
    'device_type',                'desktop',
    'os_name',                    'Windows',
    'os_version',                 '11',
