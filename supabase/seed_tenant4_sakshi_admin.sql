...
--
-- Tenant seed: Tenant_4 — enterprise plan, global_admin role.
-- User: Sakshi Sonawane <sakshi.sonawane@ideastoimpacts.com>
-- ============================================================================
--
-- HOW TO USE THIS SEED (self-hosted / staging)
-- ----------------------------------------------------------------------------
-- 1) Go to Dashboard → Authentication → Users → Add user
--    Email    : sakshi.sonawane@ideastoimpacts.com
--    Password : Test@123
...
DECLARE
  -- ==================== CONFIG ====================
  c_seed_email              TEXT    := 'sakshi.sonawane@ideastoimpacts.com';
  c_tenant_display_name     TEXT    := 'Tenant_4';
  c_full_name               TEXT    := 'Sakshi Sonawane';
  c_plan                    TEXT    := 'enterprise';  -- starter | professional | enterprise
  c_workflow_addon_slots    INTEGER := 0;             -- 0–5 (enterprise effectively unlimited)
  c_agent_packs             TEXT[]  := ARRAY['underwriting', 'claims', 'distribution', 'compliance', 'agentic-rag'];
  c_device_name             TEXT    := 'Sakshi primary device';
  c_signup_wizard_version   TEXT    := 'v1';
  c_device_profile          JSONB   := jsonb_build_object(
    'device_name',                'Sakshi primary device',
    'device_type',                'desktop',
    'os_name',                    'Windows',
    'os_version',                 '11',
