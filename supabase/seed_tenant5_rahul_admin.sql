...
--
-- Tenant seed: Tenant_5 — enterprise plan, global_admin role.
-- User: Rahul Haral <rahul.haral@ideastoimpacts.com>
-- ============================================================================
--
-- HOW TO USE THIS SEED (self-hosted / staging)
-- ----------------------------------------------------------------------------
-- 1) Go to Dashboard → Authentication → Users → Add user
--    Email    : rahul.haral@ideastoimpacts.com
--    Password : Test@123
...
DECLARE
  -- ==================== CONFIG ====================
  c_seed_email              TEXT    := 'rahul.haral@ideastoimpacts.com';
  c_tenant_display_name     TEXT    := 'Tenant_5';
  c_full_name               TEXT    := 'Rahul Haral';
  ...
  c_agent_packs             TEXT[]  := ARRAY['agentic-rag', 'compliance'];                 -- Agentic RAG Add-On + Compliance Pack
  c_device_name             TEXT    := 'Rahul primary device';
  c_signup_wizard_version   TEXT    := 'v1';
  c_device_profile          JSONB   := jsonb_build_object(
    'device_name',                'Rahul primary device',
    'device_type',                'desktop',
    'os_name',                    'Windows',
    'os_version',                 '11',
