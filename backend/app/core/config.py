...
try:
    OFFLINE_LLM_HTTP_TIMEOUT_SECONDS = float(os.getenv("OFFLINE_LLM_HTTP_TIMEOUT_SECONDS", "600").strip() or "600")
except ValueError:
    OFFLINE_LLM_HTTP_TIMEOUT_SECONDS = 600.0
...
# Azure Blob Storage (active storage backend for model artifacts)
